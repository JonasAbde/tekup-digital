...
export type TekkoAssetSources = {
  /** Optimized production asset. Preferred when exported. */
  webp: string;
  /** Transparent production asset. Used when WebP is not available/supported. */
  png: string;
  /** Lightweight vector fallback. Always expected to exist. */
  svg: string;
};
