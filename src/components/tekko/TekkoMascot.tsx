...
const stateMotion: Record<TekkoState, string> = {
  idle: "motion-safe:animate-[tekko-float_4s_ease-in-out_infinite]",
  thinking: "motion-safe:animate-pulse",
  working: "motion-safe:animate-[tekko-float_2.5s_ease-in-out_infinite]",
  success: "motion-safe:animate-[tekko-pop_600ms_ease-out_1]",
  warning: "",
  error: "",
